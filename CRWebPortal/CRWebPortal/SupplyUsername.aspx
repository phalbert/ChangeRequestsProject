<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplyUsername.aspx.cs" Inherits="CRWebPortal.SupplyUsername" %>
                ...
                <div class="login-box login-sidebar">
                    <div class="white-box">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group text-center m-t-20">
                                <div class="col-xs-12">
                                    <asp:Button ID="Button1" runat="server" Text="Log In" class="btn btn-success btn-lg btn-block text-uppercase waves-effect waves-light" OnClick="btnSubmit_Click"></asp:Button>
                                    <br />
                                    <br />
                                    <br />
                                    <blockquote>
