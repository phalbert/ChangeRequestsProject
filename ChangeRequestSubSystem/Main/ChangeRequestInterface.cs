...
namespace ChangeRequestSubSystem.ControlClasses
{
    ...
    public class CRSubSystemAPI : ChangeRequestInterface
    {
        ...
        public TimeBoundAccessRequest CheckForValidTimeBoundAccessRequest(SystemUser user,string typeOfAccess) => bll.CheckForValidTimeBoundAccessRequest(user,typeOfAccess);
        ...
        public ApiResult SaveGoLiveRequest(GoLiveRequest goliveRequest) => bll.SaveGoLiveRequest(goliveRequest);
    }
}
